...
public class JaegerRemoteSamplerProvider implements ConfigurableSamplerProvider {
  ...
  static final String RESOURCE_ATTRIBUTE_NAMESPACE_PROPERTY = "service.namespace";
  ...
  public Sampler createSampler(ConfigProperties config) {
    ...
    serviceNamespace = resourceAttributes.get(RESOURCE_ATTRIBUTE_NAMESPACE_PROPERTY);
    if (serviceName == null) {
